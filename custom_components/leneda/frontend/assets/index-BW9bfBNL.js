var Se=Object.defineProperty;var Ce=(s,e,t)=>e in s?Se(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var P=(s,e,t)=>Ce(s,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))a(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function a(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();const Ee="modulepreload",De=function(s){return"/leneda-panel/static/"+s},de={},E=function(e,t,a){let r=Promise.resolve();if(t&&t.length>0){let i=function(d){return Promise.all(d.map(h=>Promise.resolve(h).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));r=i(t.map(d=>{if(d=De(d),d in de)return;de[d]=!0;const h=d.endsWith(".css"),g=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${g}`))return;const v=document.createElement("link");if(v.rel=h?"stylesheet":Ee,h||(v.as="script"),v.crossOrigin="",v.href=d,l&&v.setAttribute("nonce",l),document.head.appendChild(v),h)return new Promise((y,p)=>{v.addEventListener("load",y),v.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${d}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return e().catch(n)})};function Le(){var s,e,t,a,r;try{const n=(e=(s=window.parent)==null?void 0:s.document)==null?void 0:e.querySelector("home-assistant");return((r=(a=(t=n==null?void 0:n.hass)==null?void 0:t.auth)==null?void 0:a.data)==null?void 0:r.access_token)??null}catch{return null}}async function S(s,e){const t=Le(),a={...e==null?void 0:e.headers,...t?{Authorization:`Bearer ${t}`}:{}},r={...e,credentials:"include",headers:a},n=await fetch(s,r);if(!n.ok)throw new Error(`API ${n.status}: ${n.statusText}`);return n.json()}async function z(s){return S(`/leneda_api/data?range=${s}`)}async function Me(s,e){return S(`/leneda_api/data/custom?start=${encodeURIComponent(s)}&end=${encodeURIComponent(e)}`)}async function Re(s,e,t){let a=`/leneda_api/data/timeseries?obis=${encodeURIComponent(s)}`;return e&&(a+=`&start=${encodeURIComponent(e)}`),t&&(a+=`&end=${encodeURIComponent(t)}`),S(a)}async function Pe(s,e,t){let a=`/leneda_api/data/timeseries/per-meter?obis=${encodeURIComponent(s)}`;return e&&(a+=`&start=${encodeURIComponent(e)}`),t&&(a+=`&end=${encodeURIComponent(t)}`),S(a)}async function Z(){return S("/leneda_api/sensors")}async function I(){return S("/leneda_api/config")}async function We(s){await S("/leneda_api/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)})}async function Te(){await S("/leneda_api/config/reset",{method:"POST"})}async function ve(){try{return await S("/leneda_api/mode")}catch{return{mode:"standalone",configured:!1}}}async function fe(){return S("/leneda_api/credentials")}async function Fe(s){await S("/leneda_api/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)})}async function Ie(s){return S("/leneda_api/credentials/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)})}const D=Object.freeze(Object.defineProperty({__proto__:null,fetchConfig:I,fetchCredentials:fe,fetchCustomData:Me,fetchMode:ve,fetchPerMeterTimeseries:Pe,fetchRangeData:z,fetchSensors:Z,fetchTimeseries:Re,resetConfig:Te,saveConfig:We,saveCredentials:Fe,testCredentials:Ie},Symbol.toStringTag,{value:"Module"}));function u(s,e=2){return s==null?"—":s.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:e})}function ue(s){return new Date(s).toLocaleDateString(void 0,{month:"short",day:"numeric"})}function Ae(s){return new Date(s).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}const pe=[{id:"yesterday",label:"Yesterday"},{id:"this_week",label:"This Week"},{id:"last_week",label:"Last Week"},{id:"this_month",label:"This Month"},{id:"last_month",label:"Last Month"},{id:"this_year",label:"This Year"},{id:"last_year",label:"Last Year"},{id:"custom",label:"Custom"}];function he(s){var $;const e=s.rangeData,t=(e==null?void 0:e.consumption)??0,a=(e==null?void 0:e.production)??0,r=(e==null?void 0:e.exported)??0,n=(e==null?void 0:e.self_consumed)??0,i=(e==null?void 0:e.gas_energy)??0,o=(e==null?void 0:e.gas_volume)??0,l=(e==null?void 0:e.peak_power_kw)??0,d=Math.max(0,t-n-((e==null?void 0:e.shared_with_me)??0)),h=Math.max(0,r-((e==null?void 0:e.shared)??0)),g=(e==null?void 0:e.shared)??0,v=(e==null?void 0:e.shared_with_me)??0,y=t>0?Math.min(100,n/t*100):0,p=s.range==="custom"&&s.customStart&&s.customEnd?`${ue(s.customStart+"T00:00:00")} — ${ue(s.customEnd+"T00:00:00")}`:(($=pe.find(k=>k.id===s.range))==null?void 0:$.label)??"Yesterday";return`
              ...
              <div class="glass-module consumption-module">
                <div class="module-info">
                  ...
                  <div class="module-value-row">
                    <span class="module-value highlight-red">${u(t)}</span>
  ...
  `}const me={"1-1:1.29.0":{name:"Active Consumption",unit:"kW",icon:"⚡",category:"consumption"},"1-1:2.29.0":{name:"Active Production",unit:"kW",icon:"☀️",category:"production"},"1-1:3.29.0":{name:"Reactive Consumption",unit:"kvar",icon:"⚡",category:"consumption"},"1-1:4.29.0":{name:"Reactive Production",unit:"kvar",icon:"☀️",category:"production"},"1-65:1.29.1":{name:"Consumption Covered (L1 AIR)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:1.29.3":{name:"Consumption Covered (L2 ACR)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:1.29.2":{name:"Consumption Covered (L3 CEL)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:1.29.4":{name:"Consumption Covered (L4 APS)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:1.29.9":{name:"Remaining Consumption",unit:"kW",icon:"🔗",category:"sharing"},"1-65:2.29.1":{name:"Production Shared (L1 AIR)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:2.29.3":{name:"Production Shared (L2 ACR)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:2.29.2":{name:"Production Shared (L3 CEL)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:2.29.4":{name:"Production Shared (L4 APS)",unit:"kW",icon:"🔗",category:"sharing"},"1-65:2.29.9":{name:"Remaining Production",unit:"kW",icon:"🔗",category:"sharing"},"7-1:99.23.15":{name:"Gas Volume",unit:"m³",icon:"🔥",category:"gas"},"7-1:99.23.17":{name:"Gas Standard Volume",unit:"Nm³",icon:"🔥",category:"gas"},"7-20:99.33.17":{name:"Gas Energy",unit:"kWh",icon:"🔥",category:"gas"}};function Ve(s){return me[s]?me[s].name:{c_04_yesterday_consumption:"Yesterday's Consumption",c_05_weekly_consumption:"This Week's Consumption",c_06_last_week_consumption:"Last Week's Consumption",c_07_monthly_consumption:"This Month's Consumption",c_08_previous_month_consumption:"Last Month's Consumption",p_04_yesterday_production:"Yesterday's Production",p_05_weekly_production:"This Week's Production",p_06_last_week_production:"Last Week's Production",p_07_monthly_production:"This Month's Production",p_08_previous_month_production:"Last Month's Production",p_09_yesterday_exported:"Yesterday's Export",p_10_last_week_exported:"Last Week's Export",p_11_last_month_exported:"Last Month's Export",p_12_yesterday_self_consumed:"Yesterday's Self-Consumed",p_13_last_week_self_consumed:"Last Week's Self-Consumed",p_14_last_month_self_consumed:"Last Month's Self-Consumed",p_15_monthly_exported:"This Month's Export",p_16_monthly_self_consumed:"This Month's Self-Consumed",g_01_yesterday_consumption:"Gas Yesterday (kWh)",g_02_weekly_consumption:"Gas This Week (kWh)",g_03_last_week_consumption:"Gas Last Week (kWh)",g_04_monthly_consumption:"Gas This Month (kWh)",g_05_last_month_consumption:"Gas Last Month (kWh)",g_10_yesterday_volume:"Gas Yesterday (m³)",g_11_weekly_volume:"Gas This Week (m³)",g_12_last_week_volume:"Gas Last Week (m³)",g_13_monthly_volume:"Gas This Month (m³)",g_14_last_month_volume:"Gas Last Month (m³)"}[s]??s}function Ge(s){if(!s||!s.sensors.length)return`
    ...
    `;const e=[],t=[],a=[],r=[],n=[];for(const o of s.sensors){const l=o.key;l.startsWith("c_")||l==="1-1:1.29.0"||l==="1-1:3.29.0"?e.push(o):l.startsWith("p_")||l==="1-1:2.29.0"||l==="1-1:4.29.0"?t.push(o):l.startsWith("s_")||l.startsWith("1-65:")?a.push(o):l.startsWith("g_")||l.startsWith("7-")?r.push(o):n.push(o)}const i=(o,l,d,h)=>d.length?`
    ...
    <section class="sensors-view">
      ...
      ${i("Energy Production","☀️",t,"production")}
      ${i("Energy Sharing","🔗",a,"self")}
      ${i("Gas","🔥",r,"gas")}
      ${i("Other","📊",n,"text")}
    </section>
  `}function qe(s,e,t){const a=new Date,r=(l,d)=>new Date(l,d+1,0).getDate();let n,i;switch(s){case"yesterday":{const l=new Date(a);l.setDate(l.getDate()-1),n=1,i=l;break}case"this_week":{const l=new Date(a),d=l.getDay()||7,h=new Date(l);h.setDate(l.getDate()-d+1),n=Math.max(1,Math.round((a.getTime()-h.getTime())/864e5)+1),i=h;break}case"last_week":{n=7;const l=new Date(a);l.setDate(l.getDate()-7),i=l;break}case"this_month":{n=a.getDate(),i=a;break}case"last_month":{const l=new Date(a.getFullYear(),a.getMonth()-1,1);n=r(l.getFullYear(),l.getMonth()),i=l;break}case"custom":{if(e&&t){const l=new Date(e),d=new Date(t);n=Math.max(1,Math.round((d.getTime()-l.getTime())/864e5)+1),i=l}else n=1,i=a;break}default:n=1,i=a}const o=r(i.getFullYear(),i.getMonth());return{days:n,monthDays:o,factor:n/o}}function Oe(s){const e=s.config,t=s.rangeData;if(!e||!t)return`
      <section class="invoice-view">
        <div class="card">
          <p class="muted">Loading billing configuration…</p>
        </div>
      </section>
    `;const a=t.consumption||0,r=t.production||0,n=t.exported||0,i=t.peak_power_kw||0,o=e.reference_power_kw||5,l=t.exceedance_kwh||0,d=t.gas_energy||0,h=t.gas_volume||0,g=d>0||h>0,{days:v,monthDays:y,factor:p}=qe(s.range,s.customStart,s.customEnd),$=e.energy_fixed_fee*p,k=e.network_metering_rate*p,m=e.network_power_ref_rate*p,c=v<y?`${v}/${y} days`:"full month",b=a*e.energy_variable_rate,C=a*e.network_variable_rate,L=l*e.exceedance_rate,W=e.meter_monthly_fees??[],be=W.reduce((f,x)=>f+(x.fee||0),0)*p,Y=a*e.compensation_fund_rate,B=a*e.electricity_tax_rate,V=$+b+k+m+C+L+be+Y+B,K=V*e.vat_rate,J=V+K,ke=(e.meters??[]).filter(f=>f.types.includes("production")),we=e.feed_in_rates??[],M=ke.map(f=>{const x=we.find(A=>A.meter_id===f.id);if(x){const A=x.mode==="sensor"&&x.sensor_value!=null&&isFinite(x.sensor_value),ce=A?x.sensor_value:isFinite(x.tariff)?x.tariff:e.feed_in_tariff,xe=A?`Sensor (${u(ce,4)} ${e.currency??"EUR"}/kWh)`:"Fixed tariff";return{meterId:f.id,shortId:f.id?"…"+f.id.slice(-8):"Meter",rate:ce,label:xe,mode:x.mode}}return{meterId:f.id,shortId:f.id?"…"+f.id.slice(-8):"Meter",rate:e.feed_in_tariff,label:"Fixed tariff",mode:"fixed"}}),G=M.filter(f=>isFinite(f.rate)&&f.rate>0),Q=G.length>0?G.reduce((f,x)=>f+x.rate,0)/G.length:e.feed_in_tariff,T=n*Q,R=M.length>1,F=t.self_consumed||0,ee=F*(e.energy_variable_rate+e.network_variable_rate+e.electricity_tax_rate+e.compensation_fund_rate),te=ee*e.vat_rate,q=ee+te,se=q+T,O=J-T,ae=(e.gas_fixed_fee??6.5)*p,re=d*(e.gas_variable_rate??.055),ne=(e.gas_network_fee??4.8)*p,ie=d*(e.gas_network_variable_rate??.012),oe=d*(e.gas_tax_rate??.001),U=ae+re+ne+ie+oe,le=U*(e.gas_vat_rate??.08),H=U+le,w=e.currency||"EUR",_=f=>`${u(f,2)} ${w}`,N=s.range.replace("_"," ").replace(/\b\w/g,f=>f.toUpperCase()),$e=l>0?`<div class="card exceedance-warning">
    ...
    <section class="invoice-view">
        ...
        <table class="invoice-table">
          ...
          <tbody>
            ...
            <tr class="revenue-row">
              <td>Exported (${R?f.shortId:u(n)+" kWh"})</td>
              <td style="text-align: right;">${f.label}<br/>${u(f.rate,4)} ${w}/kWh</td>
              <td class="revenue-amount" style="text-align: right;">-${_(R?n/M.length*f.rate:n*f.rate)}</td>
            </tr>
            `).join("")}
            ${R?`
            <tr class="revenue-row">
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          <strong>Combined Energy Total: ${_(O+H)}</strong>
          (Electricity: ${_(O)} + Gas: ${_(H)})
        </p>
      </div>
      `:""}
      ...
      <div class="card solar-revenue-card">
        ...
        <table class="invoice-table solar-table">
          ...
          <tbody>
            ...
            ${M.map(f=>`
            <tr>
              <td>Sold to grid ${R?`(${f.shortId})`:`(${u(n)} kWh)`}</td>
              <td style="text-align: right;">${f.label}<br/>${u(f.rate,4)} ${w}/kWh</td>
              <td style="text-align: right;">${_(R?n/M.length*f.rate:n*f.rate)}</td>
            </tr>
            `).join("")}
            ${R?`
            <tr class="subtotal-row">
  ...
  `}const Ue=[{title:"Energy Supplier",icon:"⚡",fields:[{key:"energy_fixed_fee",label:"Fixed Fee",step:"0.01",unit:"EUR/mo",type:"number"},{key:"energy_variable_rate",label:"Variable Rate",step:"0.0001",unit:"EUR/kWh",type:"number"}]},{title:"Network Operator",icon:"🔌",fields:[{key:"network_metering_rate",label:"Metering Fee",step:"0.01",unit:"EUR/mo",type:"number"},{key:"network_power_ref_rate",label:"Power Reference Fee",step:"0.01",unit:"EUR/mo",type:"number"},{key:"network_variable_rate",label:"Variable Rate",step:"0.0001",unit:"EUR/kWh",type:"number"}]},{title:"Reference Power & Exceedance",icon:"📏",fields:[{key:"reference_power_kw",label:"Reference Power (Referenzwert)",step:"0.1",unit:"kW",type:"number"},{key:"exceedance_rate",label:"Exceedance Surcharge",step:"0.0001",unit:"EUR/kWh",type:"number"}]},{title:"Feed-in / Selling",icon:"💶",fields:[]},{title:"Gas Billing",icon:"🔥",fields:[{key:"gas_fixed_fee",label:"Supplier Fixed Fee",step:"0.01",unit:"EUR/mo",type:"number"},{key:"gas_variable_rate",label:"Supplier Variable Rate",step:"0.0001",unit:"EUR/kWh",type:"number"},{key:"gas_network_fee",label:"Network Fixed Fee",step:"0.01",unit:"EUR/mo",type:"number"},{key:"gas_network_variable_rate",label:"Network Variable Rate",step:"0.0001",unit:"EUR/kWh",type:"number"},{key:"gas_tax_rate",label:"Gas Tax",step:"0.0001",unit:"EUR/kWh",type:"number"},{key:"gas_vat_rate",label:"Gas VAT Rate",step:"0.01",unit:"decimal (0.08 = 8%)",type:"number"}]},{title:"Meter Fees",icon:"📊",fields:[]},{title:"Taxes & Levies",icon:"🏛️",fields:[{key:"compensation_fund_rate",label:"Compensation Fund",step:"0.0001",unit:"EUR/kWh",type:"number"},{key:"electricity_tax_rate",label:"Electricity Tax",step:"0.0001",unit:"EUR/kWh",type:"number"},{key:"vat_rate",label:"VAT Rate",step:"0.01",unit:"decimal (0.08 = 8%)",type:"number"}]},{title:"General",icon:"⚙️",fields:[{key:"currency",label:"Currency",step:"",unit:"",type:"text"}]}],He={consumption:"Power Consumption",production:"Power Production",gas:"Gas Consumption"},ye={consumption:"⚡",production:"☀️",gas:"🔥"};function Ne(s){return s.map(e=>`<span class="meter-type-badge meter-type-${e}">${ye[e]??""} ${He[e]??e}</span>`).join(" ")}function ge(s,e,t){const a=s+1;return t?`
    ...
    <div class="meter-card">
      <div class="meter-header">
        <strong>Meter ${a}</strong>
        ${a>1?`<button type="button" class="btn-icon remove-meter-btn" data-meter="${s}" title="Remove meter">&times;</button>`:""}
      </div>
      <div class="form-row">
  ...
  `}function je(s,e="ha",t){if(!s&&e==="ha")return`
      <section class="settings-view">
        <div class="card">
          <p class="muted">Loading configuration…</p>
        </div>
      </section>
    `;const a=e==="standalone"?(t==null?void 0:t.meters)??[{id:"",types:["consumption"]}]:(s==null?void 0:s.meters)??[];let r="";if(e==="standalone"){const m=a.map((c,b)=>ge(b,c,!1)).join("");r=`
      <div class="section-header">
            ...
            <div class="form-row">
              ...
              <div class="input-group">
                <input
                  ...
                  name="energy_id"
                  type="text"
                  value="${(t==null?void 0:t.energy_id)??""}"
    ...
    `}const n=m=>m.map(c=>{const b=s?s[c.key]??"":"";return`
      ...
      `}).join(""),i=((s==null?void 0:s.meters)??[]).filter(m=>m.types.includes("production")),o=(s==null?void 0:s.feed_in_rates)??[],l=e==="ha";function d(m){return o.find(c=>c.meter_id===m)??{meter_id:m,mode:"fixed",tariff:(s==null?void 0:s.feed_in_tariff)??.08,sensor_entity:""}}const h=i.length===0?'<p class="muted">No production meters configured — add a meter with Power Production type above.</p>':i.map((m,c)=>{const b=d(m.id),C=m.id?"…"+m.id.slice(-8):`Meter ${c+1}`;return`
        ...
        `}).join(""),k=Ue.map(m=>{if(m.title==="Gas Billing"&&!g||m.title==="Meter Fees"&&v.length<2)return"";let c;return m.title==="Feed-in / Selling"?c=h:m.title==="Meter Fees"?c=`<p class="muted" style="margin: 0 0 var(--sp-3) 0; font-size: 0.85rem;">
  ...
  `}function j(s,e,t=!1){return`
    <header class="navbar" role="navigation" aria-label="Main navigation">
      <div class="navbar-brand">
        ...
        <button class="menu-toggle ${t?"open":""}" aria-label="Toggle menu" aria-expanded="${t}">
          <span></span>
          <span></span>
          <span></span>
        </button>
      ...
      <nav class="navbar-tabs ${t?"mobile-open":""}" role="tablist">
  ...
  `}const _e="leneda_credentials";function Xe(){try{const s=localStorage.getItem(_e);if(s)return JSON.parse(s)}catch{}return null}function X(s){try{localStorage.setItem(_e,JSON.stringify(s))}catch{}}class ze{constructor(e){P(this,"root");P(this,"state",{tab:"dashboard",range:"yesterday",customStart:"",customEnd:"",chartUnit:"kw",rangeData:null,sensors:null,config:null,loading:!0,error:null,mode:"ha",credentials:null,isMenuOpen:!1});P(this,"preZoomRange",null);P(this,"preZoomCustomStart","");P(this,"preZoomCustomEnd","");this.root=e}async mount(){this.render();const e=await ve();if(this.state.mode=e.mode,e.mode==="standalone"){const t=Xe();if(t&&(this.state.credentials=t),!e.configured&&!t){this.state.tab="settings",this.state.loading=!1,this.state.error="Please configure your Leneda API credentials in Settings.",this.render();return}if(!e.configured&&t)try{const{saveCredentials:a}=await E(async()=>{const{saveCredentials:r}=await Promise.resolve().then(()=>D);return{saveCredentials:r}},void 0);await a(t)}catch{}if(!t)try{this.state.credentials=await fe()}catch{}}await this.loadData()}async loadData(){this.state.loading=!0,this.state.error=null,this.render();try{const[e,t,a]=await Promise.all([z(this.state.range),Z(),I()]);this.state.rangeData=e,this.state.sensors=t,this.state.config=a}catch(e){this.state.error=e instanceof Error?e.message:"Failed to load data"}finally{this.state.loading=!1,this.render()}}async changeRange(e){if(this.preZoomRange=null,this.state.range=e,e==="custom"){if(!this.state.customStart||!this.state.customEnd){const t=new Date;t.setDate(t.getDate()-1);const a=new Date(t);a.setDate(a.getDate()-6),this.state.customStart=a.toISOString().slice(0,10),this.state.customEnd=t.toISOString().slice(0,10)}this.render();return}this.state.loading=!0,this.render();try{this.state.rangeData=await z(e)}catch(t){this.state.error=t instanceof Error?t.message:"Failed to load data"}finally{this.state.loading=!1,this.render()}}async applyCustomRange(){this.preZoomRange=null;const{customStart:e,customEnd:t}=this.state;if(!(!e||!t)){this.state.loading=!0,this.render();try{const{fetchCustomData:a}=await E(async()=>{const{fetchCustomData:n}=await Promise.resolve().then(()=>D);return{fetchCustomData:n}},void 0),r=await a(e,t);this.state.rangeData={range:"custom",consumption:r.consumption,production:r.production,exported:r.exported??0,self_consumed:r.self_consumed??0,gas_energy:r.gas_energy??0,gas_volume:r.gas_volume??0,peak_power_kw:r.peak_power_kw??0,exceedance_kwh:r.exceedance_kwh??0,metering_point:r.metering_point??""}}catch(a){this.state.error=a instanceof Error?a.message:"Failed to load custom data"}finally{this.state.loading=!1,this.render()}}}changeTab(e){this.state.tab=e,this.render(),e==="sensors"&&!this.state.sensors&&Z().then(t=>{this.state.sensors=t,this.render()}),e==="settings"&&!this.state.config&&I().then(t=>{this.state.config=t,this.render()}),this.state.isMenuOpen=!1}toggleMenu(){this.state.isMenuOpen=!this.state.isMenuOpen,this.render()}render(){var n;const{tab:e,loading:t,error:a}=this.state;if(t&&!this.state.rangeData){this.root.innerHTML=`
        <div class="app-shell">
          ${j(e)}
      ...
      `;return}if(a&&!this.state.rangeData){this.root.innerHTML=`
        <div class="app-shell">
          ${j(e)}
          <main class="main-content">
      ...
      `,(n=this.root.querySelector("#retry-btn"))==null||n.addEventListener("click",()=>this.loadData());return}let r="";switch(e){case"dashboard":r=he(this.state);break;case"sensors":r=Ge(this.state.sensors);break;case"invoice":r=Oe(this.state);break;case"settings":r=je(this.state.config,this.state.mode,this.state.credentials);break}this.root.innerHTML=`
      <div class="app-shell">
        ${j(e,i=>this.changeTab(i),this.state.isMenuOpen)}
        <main class="main-content">
          ${t?'<div class="loading-bar"></div>':""}
          ${r}
        </main>
      </div>
    `,this.attachNavListeners(),this.attachDashboardListeners(),this.attachSettingsListeners()}attachNavListeners(){var e;(e=this.root.querySelector(".menu-toggle"))==null||e.addEventListener("click",()=>{this.toggleMenu()}),this.root.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{const a=t.dataset.tab;this.changeTab(a)})})}attachDashboardListeners(e=!1){this.root.querySelectorAll("[data-range]").forEach(i=>{i.addEventListener("click",()=>{const o=i.dataset.range;this.changeRange(o)})});const t=this.root.querySelector("#custom-start"),a=this.root.querySelector("#custom-end");t&&t.addEventListener("change",()=>{this.state.customStart=t.value}),a&&a.addEventListener("change",()=>{this.state.customEnd=a.value});const r=this.root.querySelector("#apply-custom-range");if(r==null||r.addEventListener("click",()=>this.applyCustomRange()),this.root.querySelectorAll("[data-chart-unit]").forEach(i=>{i.addEventListener("click",()=>{const o=i.dataset.chartUnit;o!==this.state.chartUnit&&(this.state.chartUnit=o,this.render())})}),!e){const i=this.root.querySelector("#energy-chart");i&&this.state.rangeData&&this.initChart(i)}const n=this.root.querySelector(".reset-zoom-btn");n==null||n.addEventListener("click",async()=>{const{resetChartZoom:i}=await E(async()=>{const{resetChartZoom:o}=await import("./Charts-BziMsIc4.js");return{resetChartZoom:o}},[]);if(i(),n.style.display="none",this.preZoomRange!==null){const o=this.preZoomRange;this.state.customStart=this.preZoomCustomStart,this.state.customEnd=this.preZoomCustomEnd,this.preZoomRange=null,this.preZoomCustomStart="",this.preZoomCustomEnd="",o==="custom"?(this.state.range="custom",this.applyCustomRange()):this.changeRange(o)}else this.changeRange(this.state.range==="custom"?"yesterday":this.state.range)})}attachSettingsListeners(){const e=this.root.querySelector("#credentials-form");if(e){const r=this.root.querySelector("#add-meter-btn");r==null||r.addEventListener("click",()=>{var d,h;const o=new FormData(e),l=n(o);if(l.length<10){l.push({id:"",types:["consumption"]});const g={api_key:o.get("api_key")||((d=this.state.credentials)==null?void 0:d.api_key)||"",energy_id:o.get("energy_id")||((h=this.state.credentials)==null?void 0:h.energy_id)||"",meters:l};this.state.credentials=g,X(g),this.render()}}),this.root.querySelectorAll(".remove-meter-btn").forEach(o=>{o.addEventListener("click",()=>{var v,y;const l=parseInt(o.dataset.meter??"0",10),d=new FormData(e),h=n(d);h.splice(l,1);const g={api_key:d.get("api_key")||((v=this.state.credentials)==null?void 0:v.api_key)||"",energy_id:d.get("energy_id")||((y=this.state.credentials)==null?void 0:y.energy_id)||"",meters:h};this.state.credentials=g,X(g),this.render()})});const n=o=>{var d,h,g;const l=[];for(let v=0;v<10;v++){const y=o.get(`meter_${v}_id`);if(y===null)break;const p=[];(d=e.querySelector(`[name="meter_${v}_consumption"]`))!=null&&d.checked&&p.push("consumption"),(h=e.querySelector(`[name="meter_${v}_production"]`))!=null&&h.checked&&p.push("production"),(g=e.querySelector(`[name="meter_${v}_gas"]`))!=null&&g.checked&&p.push("gas"),l.push({id:y.trim(),types:p})}return l};e.addEventListener("submit",async o=>{o.preventDefault();const l=new FormData(e),d={api_key:l.get("api_key"),energy_id:l.get("energy_id"),meters:n(l)},h=this.root.querySelector("#creds-status");try{X(d);const{saveCredentials:g}=await E(async()=>{const{saveCredentials:v}=await Promise.resolve().then(()=>D);return{saveCredentials:v}},void 0);await g(d),h&&(h.innerHTML='<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ Credentials saved. Reloading data…</p>'),this.state.credentials=d,this.state.error=null,await this.loadData()}catch(g){h&&(h.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Save failed: ${g instanceof Error?g.message:g}</p>`)}});const i=this.root.querySelector("#test-creds-btn");i==null||i.addEventListener("click",async()=>{const o=new FormData(e),l={api_key:o.get("api_key"),energy_id:o.get("energy_id"),meters:n(o)},d=this.root.querySelector("#creds-status");d&&(d.innerHTML='<p style="color: var(--clr-muted); padding: var(--sp-3) 0;">Testing connection…</p>');try{const{testCredentials:h}=await E(async()=>{const{testCredentials:v}=await Promise.resolve().then(()=>D);return{testCredentials:v}},void 0),g=await h(l);d&&(d.innerHTML=g.success?`<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ ${g.message}</p>`:`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ ${g.message}</p>`)}catch(h){d&&(d.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Test failed: ${h instanceof Error?h.message:h}</p>`)}})}const t=this.root.querySelector("#settings-form");if(!t)return;if(t.querySelectorAll('input[type="radio"][name^="feed_in_rate_"][name$="_mode"]').forEach(r=>{r.addEventListener("change",()=>{const n=r.name.match(/feed_in_rate_(\d+)_mode/);if(!n)return;const i=n[1],o=t.querySelector(`.feed-in-fixed-fields[data-rate-idx="${i}"]`),l=t.querySelector(`.feed-in-sensor-fields[data-rate-idx="${i}"]`);o&&(o.style.display=r.value==="fixed"?"":"none"),l&&(l.style.display=r.value==="sensor"?"":"none")})}),this.state.mode==="ha"){const r=this.root.querySelector("#ha-entity-list");r&&fetch("/api/leneda/ha-entities").then(n=>n.ok?n.json():Promise.resolve({entities:[]})).then(({entities:n})=>{r.innerHTML=n.map(i=>`<option value="${i}"></option>`).join("")}).catch(()=>{})}t.addEventListener("submit",async r=>{r.preventDefault();const n=new FormData(t),i={};t.querySelectorAll('input[type="checkbox"]').forEach(y=>{i[y.name]=y.checked});const o=[],l=/^feed_in_rate_(\d+)_(.+)$/,d={},h=[],g=/^meter_fee_(\d+)_(.+)$/,v={};for(const[y,p]of n.entries()){const $=y.match(l);if($){const c=$[1],b=$[2];d[c]||(d[c]={}),d[c][b]=p;continue}const k=y.match(g);if(k){const c=k[1],b=k[2];v[c]||(v[c]={}),v[c][b]=p;continue}if(i[y]!==void 0&&typeof i[y]=="boolean")continue;const m=parseFloat(p);i[y]=isNaN(m)?p:m}for(const y of Object.keys(d).sort()){const p=d[y],$=p.mode??"fixed",k=$==="sensor"?p.fallback_tariff??p.tariff:p.tariff;o.push({meter_id:p.meter_id??"",mode:$,tariff:parseFloat(k??"0.08")||.08,sensor_entity:p.sensor_entity??""})}o.length>0&&(i.feed_in_rates=o);for(const y of Object.keys(v).sort()){const p=v[y];h.push({meter_id:p.meter_id??"",label:p.label??"",fee:parseFloat(p.fee??"0")||0})}h.length>0&&(i.meter_monthly_fees=h);try{const{saveConfig:y}=await E(async()=>{const{saveConfig:p}=await Promise.resolve().then(()=>D);return{saveConfig:p}},void 0);await y(i),this.state.config=await I(),this.render()}catch(y){alert("Failed to save: "+(y instanceof Error?y.message:y))}});const a=this.root.querySelector("#reset-config-btn");a==null||a.addEventListener("click",async()=>{if(confirm("Reset all billing rates to defaults?"))try{const{resetConfig:r}=await E(async()=>{const{resetConfig:n}=await Promise.resolve().then(()=>D);return{resetConfig:n}},void 0);await r(),this.state.config=await I(),this.render()}catch(r){alert("Failed to reset: "+(r instanceof Error?r.message:r))}})}async initChart(e){var t,a;try{const{renderEnergyChart:r}=await E(async()=>{const{renderEnergyChart:p}=await import("./Charts-BziMsIc4.js");return{renderEnergyChart:p}},[]),{fetchTimeseries:n,fetchPerMeterTimeseries:i}=await E(async()=>{const{fetchTimeseries:p,fetchPerMeterTimeseries:$}=await Promise.resolve().then(()=>D);return{fetchTimeseries:p,fetchPerMeterTimeseries:$}},void 0),{start:o,end:l}=this.getDateRangeISO(),[d,h]=await Promise.all([n("1-1:1.29.0",o,l),n("1-1:2.29.0",o,l)]),g=((t=this.state.config)==null?void 0:t.reference_power_kw)??0,v=(((a=this.state.config)==null?void 0:a.meters)??[]).filter(p=>p.types.includes("production"));let y;if(v.length>1)try{const p=await i("1-1:2.29.0",o,l);p.meters&&p.meters.length>1&&(y=p.meters)}catch(p){console.warn("Per-meter timeseries fetch failed, using merged view:",p)}r(e,d,h,{unit:this.state.chartUnit,referencePowerKw:g,perMeterProduction:y,onZoomChange:(p,$)=>{this.handleChartZoomChange(p,$)}})}catch(r){console.error("Chart init failed:",r)}}async handleChartZoomChange(e,t){try{this.preZoomRange===null&&(this.preZoomRange=this.state.range,this.preZoomCustomStart=this.state.customStart,this.preZoomCustomEnd=this.state.customEnd);const{fetchCustomData:a}=await E(async()=>{const{fetchCustomData:o}=await Promise.resolve().then(()=>D);return{fetchCustomData:o}},void 0),r=e.slice(0,10),n=t.slice(0,10),i=await a(r,n);this.state.range="custom",this.state.customStart=r,this.state.customEnd=n,this.state.rangeData={range:"custom",consumption:i.consumption,production:i.production,exported:i.exported??0,self_consumed:i.self_consumed??0,gas_energy:i.gas_energy??0,gas_volume:i.gas_volume??0,peak_power_kw:i.peak_power_kw??0,exceedance_kwh:i.exceedance_kwh??0,metering_point:i.metering_point??""},this.renderDashboardPartial()}catch(a){console.error("Zoom data fetch failed:",a)}}renderDashboardPartial(){var b,C;const e=this.root.querySelector(".dashboard");if(!e||!this.state.rangeData)return;const t=document.createElement("div");t.innerHTML=he(this.state);const a=t.querySelector(".dashboard");if(!a)return;const r=e.querySelector(".range-selector"),n=a.querySelector(".range-selector");r&&n&&r.replaceWith(n);const i=e.querySelector(".custom-range-picker"),o=a.querySelector(".custom-range-picker");i&&o?i.replaceWith(o):!i&&o?(b=e.querySelector(".range-selector"))==null||b.insertAdjacentElement("afterend",o):i&&!o&&i.remove();const l=e.querySelector(".stats-grid"),d=a.querySelector(".stats-grid");l&&d&&l.replaceWith(d);const h=e.querySelector(".flow-card"),g=a.querySelector(".flow-card");h&&g&&h.replaceWith(g);const v=e.querySelector(".metrics-card"),y=a.querySelector(".metrics-card");v&&y&&v.replaceWith(y);const p=e.querySelector(".chart-header .card-title"),$=a.querySelector(".chart-header .card-title");p&&$&&p.replaceWith($);const k=e.querySelector(".reset-zoom-btn");k&&(k.style.display=""),e.querySelectorAll("[data-range]").forEach(L=>{L.addEventListener("click",()=>{this.changeRange(L.dataset.range)})});const m=e.querySelector("#custom-start"),c=e.querySelector("#custom-end");m&&m.addEventListener("change",()=>{this.state.customStart=m.value}),c&&c.addEventListener("change",()=>{this.state.customEnd=c.value}),(C=e.querySelector("#apply-custom-range"))==null||C.addEventListener("click",()=>{this.preZoomRange=null,this.applyCustomRange()})}getDateRangeISO(){const e=new Date,t=a=>a.toISOString();switch(this.state.range){case"custom":{const a=new Date(this.state.customStart+"T00:00:00"),r=new Date(this.state.customEnd+"T23:59:59.999");return{start:t(a),end:t(r)}}case"yesterday":{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const r=new Date(a);return r.setHours(23,59,59,999),{start:t(a),end:t(r)}}case"this_week":{const a=new Date(e),r=a.getDay()||7;return a.setDate(a.getDate()-r+1),a.setHours(0,0,0,0),{start:t(a),end:t(e)}}case"last_week":{const a=new Date(e),r=a.getDay()||7,n=new Date(a);n.setDate(a.getDate()-r),n.setHours(23,59,59,999);const i=new Date(n);return i.setDate(n.getDate()-6),i.setHours(0,0,0,0),{start:t(i),end:t(n)}}case"this_month":{const a=new Date(e.getFullYear(),e.getMonth(),1);return{start:t(a),end:t(e)}}case"last_month":{const a=new Date(e.getFullYear(),e.getMonth()-1,1),r=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:t(a),end:t(r)}}case"this_year":{const a=new Date(e.getFullYear(),0,1);return{start:t(a),end:t(e)}}case"last_year":{const a=new Date(e.getFullYear()-1,0,1),r=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:t(a),end:t(r)}}default:{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const r=new Date(a);return r.setHours(23,59,59,999),{start:t(a),end:t(r)}}}}}if(window.self===window.top&&window.location.pathname.startsWith("/leneda-panel/"))window.location.href="/leneda";else{const s=document.getElementById("app");s&&new ze(s).mount()}
